    ...
    <div>
      <div className="row justify-content-center mt-5">
        <div className="col-md-5 mt-5 text-start shadow-lg p-3 mb-5 bg-body rounded">
          ...
          {loading && (<Loading />)}
          {success && (<Success success='User Registered Successfuly' />)}
          {error && (<Error error='Email already registered' />)}

          <h2 className="text-center m-3" style={{ fontSize: '32px' }}>Register Here</h2>
          <div>
            ...
            <button className="btn btn-primary mt-3 mb-3" onClick={register}>REGISTER</button> <br />
